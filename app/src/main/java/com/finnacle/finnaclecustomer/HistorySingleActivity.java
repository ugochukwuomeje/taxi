...
public class HistorySingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    private void displayCustomerRelatedObject() {
        ...
        mRatingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                historyRideInfoDb.child("rating");
    ...
    private void payPalPayment() {
        PayPalPayment payment = new PayPalPayment(new BigDecimal(rideprice), "USD", "COAL CITY DRIVE",
    ...
    ///////////////////////////////////////this is called by if the paypal payment is ok
    @Override
    ...
    public void onRoutingSuccess(ArrayList<Route> route, int shortestRouteIndex) {
        ...
        mMap.addMarker(new MarkerOptions().position(pickupLatLng).title("pickup location").icon(BitmapDescriptorFactory.fromResource(R.mipmap.pick_up)));
        mMap.addMarker(new MarkerOptions().position(destinationLatLng).title("pickup location"));
